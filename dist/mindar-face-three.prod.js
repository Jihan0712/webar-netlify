import { Scene as m, WebGLRenderer as g, sRGBEncoding as y, PerspectiveCamera as w, BufferAttribute as M, BufferGeometry as b, Mesh as x, MeshStandardMaterial as A, Group as p } from "three";
import { CSS3DRenderer as E } from "three/addons/renderers/CSS3DRenderer.js";
import { C as R } from "./controller-D-FK5vqu.js";
import { U as S } from "./ui-C5GybxGk.js";
const I = { BufferGeometry: b, BufferAttribute: M };
class C {
  constructor({
    container: a,
    uiLoading: t = "yes",
  ...
  addFaceMesh() {
    const a = this.controller.createThreeFaceGeometry(I), t = new x(a, new A({ color: 16777215 }));
